...
#define MAX_SPEED        550.0f //Max velocity
...
class Shiba_Physics : public Abstract_Actor_Physics
{
public:
    /*=====================================================
    ...
    *Parameters: 
        ...
        shiba: the enemy, used just for getting the starting x and y positions
    =======================================================*/
    Shiba_Physics( Game_Renderer* renderer, Component_Game_Actor& shiba );
    ~Shiba_Physics();
