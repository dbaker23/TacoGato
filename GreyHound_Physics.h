...
#define MAX_SPEED        500.0f //Max velocity
#define MAX_CLIMB        400.0f
#define MAX_FALL         100.0f //Max falling speed.
#define MAX_ACCEL        10.0f  //Acceleration rate
#define MAX_DECEL        15.0f  //Deceleration rate
#define MAX_JUMP_ACCEL   300.0f
#define MAX_JUMP_ADD     100.0f   //this * timeStep until max jump height
#define MAX_JUMP_HEIGHT  10

class GreyHound_Physics : public Abstract_Actor_Physics
{
public:
    /*=====================================================
    ...
    *Parameters: 
        ...
        greyHound: the enemy, used just for getting the starting x and y positions
    =======================================================*/
    GreyHound_Physics( Game_Renderer* renderer, Component_Game_Actor& greyHound );
    ~GreyHound_Physics();
