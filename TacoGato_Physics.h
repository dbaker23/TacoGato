...
#define MAX_FALL         750.0f //Max falling speed.
#define MAX_ACCEL        100.0f  //Acceleration rate
...
class TacoGato_Physics : public Abstract_Actor_Physics
{
public:
    /*=====================================================
    ...
    *Parameters: 
        ...
        taco: the hero, used just for getting the starting x and y positions
    =======================================================*/
    TacoGato_Physics( Game_Renderer* renderer, Component_Game_Actor& taco );
    ~TacoGato_Physics();
