...
#define MAX_FALL         500.0f //Max falling speed.
...
class Husky_Physics : public Abstract_Actor_Physics
{
public:
    /*=====================================================
    ...
    *Parameters: 
        ...
        husky: the enemy, used just for getting the starting x and y positions
    =======================================================*/
    Husky_Physics( Game_Renderer* renderer, Component_Game_Actor& husky );
    ~Husky_Physics();
